...
def huodong():
    ...
    for i in range(0,3):
        ...
        swipe(Template(r"t../perf_auto/images/fhmj_img/tuodong3.png", record_pos=(-0.317, 0.0), resolution=(2400, 1080)), vector=[-0.0058, -0.3408])
        poco(text="川麻雀神杯").click()
        poco(text="麻将话费").click()
        swipe(Template(r"../perf_auto/images/fhmj_img/tuodong4.png", record_pos=(-0.262, 0.012), resolution=(2400, 1080)), vector=[0.0084, 0.2987])
    poco("ui_close").click()